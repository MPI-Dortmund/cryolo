...
In the folder :file:`train_annot` you just created, you will find three subdirectories :file:`CBOX_FILAMENT`. One file for each tomogram. Each file contains filament coordinates segmented (according :guilabel:`inter-box distance`) into several boxes.
