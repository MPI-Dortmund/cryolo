...
* Change the default value of "max_box_per_image" in the config.json from 700 to 3000. If this value is lower than the number of particles per micrograph, not all particle are taken into account during training. 3000 should be a safe for most cases.
